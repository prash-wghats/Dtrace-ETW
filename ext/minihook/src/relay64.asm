...
PUBLIC OrbitPrologAsm
OrbitPrologAsm PROC FRAME
   ...
   .pushreg rbp                 
    ...
    sub     RSP , 16                
    movdqu  xmmword ptr[RSP], xmm0  ;// Save XMM0 
    sub     RSP , 16                
    movdqu  xmmword ptr[RSP], xmm1
    sub     RSP , 16                
    movdqu  xmmword ptr[RSP], xmm2  ;// Save XMM0 
    sub     RSP , 16                
...
PUBLIC OrbitEpilogAsm
OrbitEpilogAsm PROC FRAME
