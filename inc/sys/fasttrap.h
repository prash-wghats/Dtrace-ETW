...
#define FASTTRAPIOC	0x8100
#define FUNCTION1	0x930

#define	FASTTRAPIOC_MAKEPROBE	CTL_CODE(FASTTRAPIOC, FUNCTION1+1, METHOD_NEITHER, FILE_ANY_ACCESS)
#define	FASTTRAPIOC_GETINSTR	CTL_CODE(FASTTRAPIOC, FUNCTION1+2, METHOD_NEITHER, FILE_ANY_ACCESS)
#define	FASTTRAPIOC_INTRPTCB	CTL_CODE(FASTTRAPIOC, FUNCTION1+2, METHOD_NEITHER, FILE_ANY_ACCESS)
#if __AMD64__
#define FASTTRAPIOC_MODPAGE	CTL_CODE(FASTTRAPIOC, FUNCTION1+3, METHOD_NEITHER, FILE_ANY_ACCESS)
#endif
