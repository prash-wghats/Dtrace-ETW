...
#else
	uint32_t ftpc_acount;			/* count of active providers */
	uint32_t ftpc_rcount;			/* count of extant providers */
#endif
...
#define	fasttrap_suword32(_k, _u)	suword32((_k), (_u))
#define	fasttrap_suword64(_k, _u)	suword64((_k), (_u))
