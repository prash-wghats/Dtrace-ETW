...
#else
#define	DTRACE_CLASS_ETW	5	/* ETW dependency */
#define	DTRACE_CLASS_COMMON	6	/* common to all systems */
#define	DTRACE_CLASS_MAX	6	/* maximum valid class */
#endif
...
#define DTRACEIOC	0x8000
#define FUNCTION	0x900
#define	DTRACEIOC_PROVIDER	CTL_CODE(DTRACEIOC, FUNCTION+1, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* provider query */
#define	DTRACEIOC_PROBES	CTL_CODE(DTRACEIOC, FUNCTION+2, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* probe query */
#define	DTRACEIOC_BUFSNAP	CTL_CODE(DTRACEIOC, FUNCTION+4, METHOD_NEITHER, FILE_ANY_ACCESS)	
							/* snapshot buffer */
#define	DTRACEIOC_PROBEMATCH	CTL_CODE(DTRACEIOC, FUNCTION+5, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* match probes */
#define	DTRACEIOC_ENABLE	CTL_CODE(DTRACEIOC, FUNCTION+6, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* enable probes */
#define	DTRACEIOC_AGGSNAP	CTL_CODE(DTRACEIOC, FUNCTION+7, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* snapshot agg. */
#define	DTRACEIOC_EPROBE	CTL_CODE(DTRACEIOC, FUNCTION+8, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* get eprobe desc. */
#define	DTRACEIOC_PROBEARG	CTL_CODE(DTRACEIOC, FUNCTION+9, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* get probe arg */
#define	DTRACEIOC_CONF		CTL_CODE(DTRACEIOC, FUNCTION+10, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* get config. */
#define	DTRACEIOC_STATUS	CTL_CODE(DTRACEIOC, FUNCTION+11, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* get status */
#define	DTRACEIOC_GO		CTL_CODE(DTRACEIOC, FUNCTION+12, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* start tracing */
#define	DTRACEIOC_STOP		CTL_CODE(DTRACEIOC, FUNCTION+13, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* stop tracing */
#define	DTRACEIOC_AGGDESC	CTL_CODE(DTRACEIOC, FUNCTION+15, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* get agg. desc. */
#define	DTRACEIOC_FORMAT	CTL_CODE(DTRACEIOC, FUNCTION+16, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* get format str */
#define	DTRACEIOC_DOFGET	CTL_CODE(DTRACEIOC, FUNCTION+17, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* get DOF */
#define	DTRACEIOC_REPLICATE	CTL_CODE(DTRACEIOC, FUNCTION+18, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* replicate enab */
#define	DTRACEIOC_USERMOD	CTL_CODE(DTRACEIOC, FUNCTION+19, METHOD_NEITHER, FILE_ANY_ACCESS)
							/* loaded user module info */

typedef struct dtrace_user_module {
	uintptr_t imgbase;
	uintptr_t mdl;
	uintptr_t buf;
	uint64_t size;
	...
	struct dtrace_user_module *next;
...
#else
#define	DTRACEHIOC 0x9000

#define	DTRACEHIOC_ADD		CTL_CODE(DTRACEHIOC, FUNCTION+1, METHOD_NEITHER, FILE_ANY_ACCESS)
#define	DTRACEHIOC_REMOVE	CTL_CODE(DTRACEHIOC, FUNCTION+2, METHOD_NEITHER, FILE_ANY_ACCESS)
#define	DTRACEHIOC_ADDDOF	CTL_CODE(DTRACEHIOC, FUNCTION+3, METHOD_NEITHER, FILE_ANY_ACCESS)
#endif
...
typedef struct dtrace_pops {
	...
	void (*dtps_provide_module)(void *arg, void *mp);
#if !defined(windows)
	int (*dtps_enable)(void *arg, dtrace_id_t id, void *parg);
#else
	int (*dtps_enable)(void *arg, dtrace_id_t id, void *parg, int);
#endif
...
#define DTRACE_INVOP_MOV_EDI_EDI0_V0	6
#define DTRACE_INVOP_SUB_RSP_8		7
#define DTRACE_INVOP_SUB_RSP_32		8
#define DTRACE_INVOP_ADD_RSP_8		9
#define DTRACE_INVOP_ADD_RSP_32		10
