...
#if defined(windows)
	int dtpr_stackon;				/* (ETW) enable stacktrace for this probe */
#endif
};

typedef int dtrace_probekey_f(char *, const char *, int);
...
extern uintptr_t dtrace_getreg(void *, uint_t);
