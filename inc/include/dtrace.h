...
#else
extern HANDLE dtrace_ctlfd(dtrace_hdl_t *);
#endif
...
#if defined(_MSC_VER) && !defined(LIBDTRACE_EXPORTS)
__declspec( dllimport ) const char *const _dtrace_version;
__declspec( dllimport ) int _dtrace_debug;
#else
